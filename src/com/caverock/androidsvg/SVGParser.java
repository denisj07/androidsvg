...
public class SVGParser extends DefaultHandler2 {
				...
				while (!scan.empty()) {
					...
					if (Float.isNaN(x))
						throw new SAXException(
								"Invalid <" + tag + "> points attribute. Non-coordinate content found in list.");
	...
	* 
	*/
	private static void parsePreserveAspectRatio(SVG.SvgPreserveAspectRatioContainer obj, String val)
			throws SAXException {
		TextScanner scan = new TextScanner(val);
		scan.skipWhitespace();
	...
	private static void parseFont(Style style, String val) throws SAXException {
		...
		style.specifiedFlags |= (SVG.SPECIFIED_FONT_FAMILY | SVG.SPECIFIED_FONT_SIZE | SVG.SPECIFIED_FONT_WEIGHT
